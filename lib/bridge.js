...
(function initBridge(globalScope) {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      '.gpt2md-checkbox{' +
        ...
        'accent-color:#2383f6;margin:0;' +
      '}' +
      '.gpt2md-message-container{position:relative;}' +
      '#gpt2md-action-bar,#gpt2md-batch-action-bar{' +
        'position:fixed;bottom:18px;left:50%;z-index:99999;' +
        'width:min(760px,calc(100vw - 40px));min-height:56px;' +
        'transform:translateX(-50%);' +
        'background:rgba(55,55,55,0.94);border:1px solid rgba(255,255,255,0.10);' +
        'border-radius:10px;box-shadow:0 14px 28px rgba(0,0,0,0.28);' +
      ...
      '}' +
      '.gpt2md-action-btn{' +
        'height:38px;min-width:118px;padding:0 16px;border:1px solid rgba(255,255,255,0.20);' +
        'border-radius:8px;background:rgba(255,255,255,0.04);color:#eeeeee;' +
        'font-size:14px;font-weight:560;letter-spacing:0;cursor:pointer;font-family:inherit;' +
        'display:inline-flex;align-items:center;justify-content:center;gap:8px;' +
        'transition:background 120ms ease,border-color 120ms ease,transform 120ms ease;' +
      '}' +
      '.gpt2md-action-btn:hover{background:rgba(255,255,255,0.10);border-color:rgba(255,255,255,0.30);}' +
      '.gpt2md-action-btn::before{font-size:18px;line-height:1;font-weight:400;color:currentColor;}' +
      '.gpt2md-select-all-btn::before{content:"✓";}' +
      '.gpt2md-deselect-all-btn::before{content:"☐";}' +
      '.gpt2md-export-icon-btn::before{content:"↓";}' +
      '.gpt2md-cancel-btn::before{content:"×";font-size:22px;}' +
      '.gpt2md-primary-btn{' +
        'min-width:210px;background:#2383f6;border-color:#2383f6;color:#fff;' +
      '}' +
      '.gpt2md-primary-btn:hover{background:#1678ed;border-color:#1678ed;}' +
      '.gpt2md-primary-btn:disabled{opacity:0.55;cursor:not-allowed;}' +
      '@media(max-width:760px){' +
        '#gpt2md-action-bar,#gpt2md-batch-action-bar{width:calc(100vw - 24px);bottom:12px;padding:10px;gap:8px;flex-wrap:wrap;justify-content:center;}' +
        '.gpt2md-action-btn{min-width:104px;height:36px;padding:0 12px;font-size:13px;}' +
        '.gpt2md-primary-btn{min-width:180px;}' +
      '}';
  ...
  function injectActionBar() {
    ...
    exportBtn.className = 'gpt2md-action-btn gpt2md-primary-btn gpt2md-export-icon-btn';
